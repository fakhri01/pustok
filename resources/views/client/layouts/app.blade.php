                                ...
                                <div class="row space-db--30">
                                    <div class="col-lg-8 mb--30">
                                        <a href="" class="promo-image promo-overlay">
                                            <img src="{{asset('client/assets/image/bg-images/promo-banner-with-text-big.jpg')}}" alt="">
                                        </a>
                                    </div>
                                    <div class="col-lg-4 mb--30">
                                        <a href="" class="promo-image promo-overlay">
                                            <img src="{{asset('client/assets/image/bg-images/promo-banner-with-text-2--small.jpg')}}" alt="">
                                        </a>
                                    </div>
                                </div>
                            </div>
